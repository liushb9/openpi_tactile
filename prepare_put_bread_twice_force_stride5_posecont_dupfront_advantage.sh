...
RAW_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/stride5/put_bread_twice"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="put_bread_twice_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_put_bread_twice_force_stride5_posecont_dupfront_192x256_advantage"
...
echo "[prepare] Rebuilding put_bread_twice LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
"$PYTHON_BIN" examples/libero/convert_hanoi_stride5_to_lerobot_force.py \
