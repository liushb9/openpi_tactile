...
TASK_NAME="pi05_pick_flower_origin_synth0522_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-pick_flower_origin_synth0522_success_advantage_from_origin29999_h30}"
