...
TASK_NAME="pi05_twist_bottle_cap_origin_combined0526_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-twist_bottle_cap_origin_combined0526_success_advantage_from_origin19999_h30_10k}"
