...
ROLLOUT_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/Rollout/twist_bottle_cap1"
ROLLOUT_SUCCESS_DIR="/mnt/public/gaojiahuan/liushengbang/Data/Rollout/twist_bottle_cap1_success_only"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="twist_bottle_cap_origin_rollout1_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_twist_bottle_cap_origin_rollout1_force_stride5_posecont_dupfront_192x256_advantage_10k"
...
for episode in 0 1 2 4 5 6 7 8 11 12 14 19 20 23 26 27 33 34; do
...
if [[ "$success_count" != "18" ]]; then
  echo "Expected 18 successful rollout symlinks, got $success_count" >&2
  exit 1
fi

echo "[prepare] Rebuilding origin + twist_bottle_cap1 successful rollout LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
