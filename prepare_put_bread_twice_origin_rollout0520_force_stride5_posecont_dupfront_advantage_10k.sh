...
ROLLOUT_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/Rollout/put_bread_twice_0520_force_stride5_posecont_dupfront_chunk4"
ROLLOUT_CSV="$ROLLOUT_DATA_DIR/annotation.csv"
ROLLOUT_SUCCESS_DIR="/mnt/public/gaojiahuan/liushengbang/Data/Rollout/put_bread_twice_0520_force_stride5_posecont_dupfront_chunk4_success_only"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="put_bread_twice_origin_rollout0520_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_put_bread_twice_origin_rollout0520_force_stride5_posecont_dupfront_192x256_advantage_10k"
...
print(f"put_bread_twice rollout0520: success={count}, marked_fail={len(marked)}")
PY

success_count="$(find "$ROLLOUT_SUCCESS_DIR" -maxdepth 1 -type l -name '*.hdf5' | wc -l)"
if [[ "$success_count" != "13" ]]; then
  echo "Expected 13 successful rollout symlinks, got $success_count" >&2
  exit 1
fi
