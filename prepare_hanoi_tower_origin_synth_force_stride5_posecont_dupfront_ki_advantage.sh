...
REPO_NAME="hanoi_tower_origin_synth_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_hanoi_tower_origin_synth_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding hanoi_tower origin + synthetic LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
