...
TASK_NAME="pi05_pick_flower_origin_flower520_523_combined_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-pick_flower_origin_flower520_523_combined_success_advantage_ki_from_origin29999_h30}"
