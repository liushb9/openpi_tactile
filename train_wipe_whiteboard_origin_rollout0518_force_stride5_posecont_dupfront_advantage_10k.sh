...
TASK_NAME="pi05_wipe_whiteboard_origin_rollout0518_force_stride5_posecont_dupfront_192x256_advantage_10k"
EXP_NAME="${EXP_NAME:-wipe_whiteboard_origin_rollout0518_success_advantage_from_origin20000_h30_10k}"
