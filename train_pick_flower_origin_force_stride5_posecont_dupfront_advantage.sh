...
TASK_NAME="pi05_pick_flower_origin_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-pick_flower_origin_success_advantage_pi05droid_h30}"
