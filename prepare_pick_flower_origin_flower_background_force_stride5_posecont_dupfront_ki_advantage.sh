...
SYNTH_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/synthetic_data/flower_background"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="pick_flower_origin_flower_background_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_pick_flower_origin_flower_background_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding pick_flower origin + flower_background synthetic LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
