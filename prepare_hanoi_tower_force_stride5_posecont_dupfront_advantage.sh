...
RAW_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/stride5/hanoi_tower"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="hanoi_tower_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_hanoi_tower_force_stride5_posecont_dupfront_192x256_advantage"
...
echo "[prepare] Rebuilding hanoi_tower LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
