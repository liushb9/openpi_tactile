...
REPO_NAME="wipe_whiteboard_origin_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_wipe_whiteboard_origin_force_stride5_posecont_dupfront_192x256_advantage"
...
echo "[prepare] Rebuilding origin-only wipe_whiteboard LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
