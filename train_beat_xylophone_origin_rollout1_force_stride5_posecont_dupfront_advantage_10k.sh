...
TASK_NAME="pi05_beat_xylophone_origin_rollout1_force_stride5_posecont_dupfront_192x256_advantage_10k"
EXP_NAME="${EXP_NAME:-beat_xylophone_origin_rollout1_success_advantage_from_origin19999_h30_10k}"
