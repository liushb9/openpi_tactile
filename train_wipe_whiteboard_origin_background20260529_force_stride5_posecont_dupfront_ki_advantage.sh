...
TASK_NAME="pi05_wipe_whiteboard_origin_background20260529_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-wipe_whiteboard_origin_background20260529_success_advantage_ki_from_origin20000_h30_10k}"
OVERWRITE_FLAG="${OVERWRITE_FLAG:---overwrite}"
NUM_WORKERS="${NUM_WORKERS:-8}"
FSDP_DEVICES="${FSDP_DEVICES:-8}"

export HF_LEROBOT_HOME
export OPENPI_DATA_HOME="$OPENPI_DIR"
