...
class Pi0(_model.BaseModel):
    def __init__(self, config: pi0_config.Pi0Config, rngs: nnx.Rngs):
        ...
        # Force conditioning encoder.
        self.config = config
        self.force_encoder = None
        if config.use_force_condition:
            force_input_dim = config.force_dim * config.force_history_len
    ...
    def embed_suffix(
        ...
        if self.pi05:
            ...
            # Inject force conditioning if enabled.
            if self.force_encoder is not None and obs.force_history is not None:
                B = obs.force_history.shape[0]
