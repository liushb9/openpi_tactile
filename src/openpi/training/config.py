...
_CONFIGS = [
    ...
    # Force-conditioned pick_flower task.
    TrainConfig(
    ...
    # Force-conditioned pick_flower (duplicate front camera as wrist).
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="pick_flower_force_dupfront",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
            extra_delta_transform=False,
    ...
    # Force-conditioned wipe_whiteboard (duplicate front camera as wrist).
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="wipe_whiteboard_force_dupfront",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
            extra_delta_transform=False,
    ...
    # Force-conditioned pick_flower framestep5 (dupfront, 5x subsampled).
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="pick_flower_force_framestep5",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
            extra_delta_transform=False,
    ...
    # Force-conditioned wipe_whiteboard framestep5 (dupfront, 5x subsampled).
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="wipe_whiteboard_force_framestep5",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
            extra_delta_transform=False,
