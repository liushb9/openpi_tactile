...
TASK_NAME="pi05_wipe_whiteboard_iteration2_force_stride5_posecont_dupfront_192x256"
EXP_NAME="${EXP_NAME:-wipe_whiteboard_iteration2_origin_synth12_from_iteration1_0506_h30_fscale10}"
