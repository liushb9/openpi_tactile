...
TASK_NAME="pi05_beat_xylophone_force_stride5_posecont_dupfront_192x256"
EXP_NAME="${EXP_NAME:-beat_xylophone_stride5_posecont_dupfront_192x256_droidinit_h30_fscale10}"
