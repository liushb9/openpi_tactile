...
SYNTH_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/World-RL/Data/OOD/background/wipe20260529_061807_combined"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="wipe_whiteboard_origin_background20260529_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_wipe_whiteboard_origin_background20260529_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding wipe_whiteboard origin + background20260529 LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
