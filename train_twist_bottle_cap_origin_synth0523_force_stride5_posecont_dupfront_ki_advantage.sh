...
TASK_NAME="pi05_twist_bottle_cap_origin_synth0523_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-twist_bottle_cap_origin_synth0523_success_advantage_ki_from_origin19999_h30}"
