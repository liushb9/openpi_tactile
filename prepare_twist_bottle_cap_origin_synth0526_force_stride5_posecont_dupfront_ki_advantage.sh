...
REPO_NAME="twist_bottle_cap_origin_synth0526_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_twist_bottle_cap_origin_synth0526_force_stride5_posecont_dupfront_192x256_ki_advantage"
