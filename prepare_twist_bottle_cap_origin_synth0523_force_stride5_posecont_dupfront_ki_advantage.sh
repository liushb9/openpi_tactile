...
REPO_NAME="twist_bottle_cap_origin_synth0523_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_twist_bottle_cap_origin_synth0523_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding twist_bottle_cap origin + synthetic0523 LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
