...
RAW_DATA_DIR="/share/project/liushengbang/Data/Origin/twist_bottle_cap"

OUTPUT_ROOT="/share/project/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="twist_bottle_cap_force_stride5_posecont_dupfront_192x256"
CONFIG_NAME="pi05_twist_bottle_cap_force_stride5_posecont_dupfront_192x256"
...
if [[ -d "$OUTPUT_ROOT/$REPO_NAME" ]]; then
  ...
  echo "[prepare] Converting twist_bottle_cap data -> $OUTPUT_ROOT/$REPO_NAME"
