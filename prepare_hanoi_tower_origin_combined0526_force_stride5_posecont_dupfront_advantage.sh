...
REPO_NAME="hanoi_tower_origin_combined0526_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_hanoi_tower_origin_combined0526_force_stride5_posecont_dupfront_192x256_advantage"
