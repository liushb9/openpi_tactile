...
REPO_NAME="beat_xylophone_origin_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_beat_xylophone_origin_force_stride5_posecont_dupfront_192x256_advantage"
...
echo "[prepare] Rebuilding origin-only beat_xylophone LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
