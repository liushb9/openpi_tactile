...
TASK_NAME="pi05_beat_xylophone_origin_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-beat_xylophone_origin_success_advantage_pi05droid_h30_20k}"
