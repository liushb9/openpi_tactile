...
TASK_NAME="pi05_pick_flower_origin_synth0522_0523_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-pick_flower_origin_synth0522_0523_success_advantage_ki_from_synth0522_29999_h30}"
