...
TASK_NAME="pi05_beat_xylophone_origin_synth0527_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-beat_xylophone_origin_synth0527_success_advantage_ki_from_origin19999_h30}"
