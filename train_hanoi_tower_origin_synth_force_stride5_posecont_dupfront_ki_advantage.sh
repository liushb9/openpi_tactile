...
TASK_NAME="pi05_hanoi_tower_origin_synth_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-hanoi_tower_origin_synth_success_advantage_ki_from_origin19999_h30}"
