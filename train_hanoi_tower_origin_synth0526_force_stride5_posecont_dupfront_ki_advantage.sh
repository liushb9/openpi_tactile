...
TASK_NAME="pi05_hanoi_tower_origin_synth0526_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-hanoi_tower_origin_synth0526_success_advantage_ki_from_origin_synth29999_h30}"
