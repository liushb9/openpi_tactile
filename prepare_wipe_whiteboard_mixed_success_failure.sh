...
SUCCESS_DIR="/mnt/public2/liushengbang/Data/success_wipe"
...
REPO_NAME="wipe_whiteboard_force_stride5_posecont_dupfront_192x256_mixed_success_failure"
CONFIG_NAME="pi05_wipe_whiteboard_force_stride5_posecont_dupfront_192x256_mixed_success_failure"
...
echo "[prepare-mixed] Converting mixed data -> $OUTPUT_ROOT/$REPO_NAME"
...
echo "[prepare-mixed] Computing norm stats for config $CONFIG_NAME"
