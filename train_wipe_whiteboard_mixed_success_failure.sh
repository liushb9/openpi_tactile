...
TASK_NAME="pi05_wipe_whiteboard_force_stride5_posecont_dupfront_192x256_mixed_success_failure"
EXP_NAME="${EXP_NAME:-wipe_whiteboard_mixed_success_failure_from20k}"
