...
TASK_NAME="pi05_twist_bottle_cap_force_stride5_posecont_dupfront_192x256"
EXP_NAME="${EXP_NAME:-twist_bottle_cap_stride5_posecont_dupfront_192x256_droidinit_h30_fscale10}"
