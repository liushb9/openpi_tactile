...
TASK_NAME="pi05_pick_bread_twice_force_stride5_posecont_dupfront_192x256"
EXP_NAME="${EXP_NAME:-pick_bread_twice_stride5_posecont_dupfront_192x256_droidinit_h30_fscale10}"
