...
TASK_NAME="pi05_wipe_whiteboard_origin_synth0522_0523_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-wipe_whiteboard_origin_synth0522_0523_success_advantage_from_synth0522_20000_h30}"
