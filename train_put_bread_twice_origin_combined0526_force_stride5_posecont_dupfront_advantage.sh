...
TASK_NAME="pi05_put_bread_twice_origin_combined0526_force_stride5_posecont_dupfront_192x256_advantage"
EXP_NAME="${EXP_NAME:-put_bread_twice_origin_combined0526_success_advantage_from_origin19999_h30_20k}"
