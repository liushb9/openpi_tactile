...
REPO_NAME="put_bread_twice_origin_synth_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_put_bread_twice_origin_synth_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding put_bread_twice origin + synthetic LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
