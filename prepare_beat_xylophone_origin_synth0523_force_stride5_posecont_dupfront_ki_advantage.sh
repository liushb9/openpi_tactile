...
SYNTH_DATA_DIR="/mnt/public/gaojiahuan/liushengbang/Data/synthetic_data/beat_xylophone_0523_combined"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="beat_xylophone_origin_synth0523_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_beat_xylophone_origin_synth0523_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding beat_xylophone origin + synthetic0523 LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
