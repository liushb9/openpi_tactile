...
TASK_NAME="pi05_hanoi_tower_origin_rollout0520_force_stride5_posecont_dupfront_192x256_advantage_10k"
EXP_NAME="${EXP_NAME:-hanoi_tower_origin_rollout0520_success_advantage_from_origin19999_h30_10k}"
