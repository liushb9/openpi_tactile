...
SYNTH_SUBSET_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/synthetic_data/pick_flower_synth0522_0523_random191_seed20260527"
SYNTH_DATA_DIR_0522="$SYNTH_SUBSET_ROOT/pick_flower1_0522"
SYNTH_DATA_DIR_0523="$SYNTH_SUBSET_ROOT/pick_flower_0523_combined"
OUTPUT_ROOT="/mnt/public/gaojiahuan/liushengbang/Data/processed_lerobot/wan_worldrl_stride5_posecont_192x256"
REPO_NAME="pick_flower_origin_synth0522_0523_half191_force_stride5_posecont_dupfront_192x256_success_advantage"
CONFIG_NAME="pi05_pick_flower_origin_synth0522_0523_half191_force_stride5_posecont_dupfront_192x256_ki_advantage"
...
echo "[prepare] Rebuilding origin + fixed random half synthetic LeRobot dataset -> $OUTPUT_ROOT/$REPO_NAME"
