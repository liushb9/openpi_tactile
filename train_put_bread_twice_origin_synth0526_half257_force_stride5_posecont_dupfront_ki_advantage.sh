...
TASK_NAME="pi05_put_bread_twice_origin_synth0526_half257_force_stride5_posecont_dupfront_192x256_ki_advantage"
EXP_NAME="${EXP_NAME:-put_bread_twice_origin_synth0526_half257_success_advantage_ki_from_origin_synth29999_h30}"
