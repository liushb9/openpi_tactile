"""Convert pick_flower original HDF5 plus two synthetic rollout datasets.

Sources:
  - original_hdf5_dir: raw World-RL HDF5 episodes, sampled with stride=5.
  - synthetic_dir_0522: episode dirs with video.mp4/actions.npy/tactile.npy.
  - synthetic_dir_0523: episode dirs with video.mp4/actions.npy/tactile.npy.
...
def main(
    ...
    synthetic_dir_0522: str,
    synthetic_dir_0523: str,
    repo_name: str = "pick_flower_origin_synth0522_0523_force_stride5_posecont_dupfront_192x256_success_advantage",
    output_dir: str | None = None,
    overwrite: bool = False,
    task: str = "pick up the flower and put it in the vase",
    ...
    synthetic_0522_count = add_video_episodes(
        dataset,
        Path(synthetic_dir_0522),
        task=task,
        force_history_len=force_history_len,
        image_height=image_height,
        image_width=image_width,
    ...
    synthetic_0523_count = add_video_episodes(
        dataset,
        Path(synthetic_dir_0523),
        task=task,
        force_history_len=force_history_len,
        image_height=image_height,
        image_width=image_width,
    ...
    print(
        ...
        f"synthetic_0522={synthetic_0522_count}, "
        f"synthetic_0523={synthetic_0523_count}, "
        f"advantage={advantage_value}"
    )
