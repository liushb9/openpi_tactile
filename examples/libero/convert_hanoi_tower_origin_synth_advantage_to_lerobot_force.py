"""Convert hanoi_tower original HDF5 plus synthetic rollout data to LeRobot.
...
def main(
    ...
    synthetic_dir: str,
    synthetic_dir_2: str = "",
    repo_name: str = "hanoi_tower_origin_synth_force_stride5_posecont_dupfront_192x256_success_advantage",
