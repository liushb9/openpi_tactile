"""Convert beat_xylophone original HDF5 plus synthetic rollout data to LeRobot.
...
def main(
    ...
    synthetic_dir: str,
    repo_name: str = "beat_xylophone_origin_synth0523_force_stride5_posecont_dupfront_192x256_success_advantage",
    output_dir: str | None = None,
    overwrite: bool = False,
    task: str = "Beat the xylophone",
