"""Convert wipe_whiteboard original HDF5 plus two synthetic rollout datasets.
...
def main(
    ...
    repo_name: str = "wipe_whiteboard_origin_synth0522_0523_force_stride5_posecont_dupfront_192x256_success_advantage",
