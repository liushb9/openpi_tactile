"""Convert pick_flower original HDF5 plus synthetic rollout data to LeRobot.
...
def main(
    ...
    synthetic_dir: str,
    repo_name: str = "pick_flower_origin_synth0522_force_stride5_posecont_dupfront_192x256_success_advantage",
