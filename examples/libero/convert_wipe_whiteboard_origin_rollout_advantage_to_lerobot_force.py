"""Convert wipe_whiteboard origin HDF5 plus successful rollout HDF5 to LeRobot.
...
def main(
    ...
    repo_name: str = "wipe_whiteboard_origin_rollout0518_force_stride5_posecont_dupfront_192x256_success_advantage",
