"""Convert pick_flower origin HDF5 plus successful rollout HDF5 to LeRobot.

The origin data is raw and sampled with stride=5. The rollout directory is
already produced at the stride5 rate, so it is imported with stride=1.
...
def main(
    ...
    repo_name: str = "pick_flower_origin_rollout0520_force_stride5_posecont_dupfront_192x256_success_advantage",
